...
Yesterday, I pushed to the Play Store the newest (and probably final) update for Meme Masters (though it will still take a few days until the Play Store entry is updated for everyone). It includes all the aforementioned features, as well as custom matches!
