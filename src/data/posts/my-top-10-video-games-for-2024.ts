...
Duskers is a very challenging game, and relatively unforgiving. While the base game is easy to learn, mastering it comes to understanding how the different mechanics weave together and how cautious you can be.
...
Its big 'hook' is the fact that the entire game's rules, systems, mechanics and plot are largely told through an in-game manual that is mostly written in a fictional language. What's more, the pages of the manual are scattered across the world for you to find in order to slowly piece together the game.
...
The game's twists and turns are effective and fun to play through.


To me, Tunic is a masterful game that at this point in time is the pinnacle of the top-down adventure formula that started with Zelda.
...
The game's whole challenge and appeal comes from the fact that you have limited actions/turns to act, and because of that you can (and should) give great thought to what goes where. Combine that with interesting systems that intertwine in dynamic ways, and you get one of the most engaging games about creating cool, complex ecosystems.
...
That's all, really. It's simple, it's effective. We Love Katamari is one of my top games of this year by simply being extremely fun to play and replay. I can't really think of any game that would genuinely make me as happy playing it as this title.
...
Animal Well is a challenging game conveyed without any dialogue and no conventional tutorial. You learn things via the expert game design of the rooms and the items, because the game developers are able to predict what you'll do and what you'll explore.


It's an absolute blast to play a game that really feels like it respects your intelligence, and it's so rewarding to play through & solve the dark & mysterious world of Animal Well.
